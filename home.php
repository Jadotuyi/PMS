...
<body>
    ...
    <form method="post" action="">
                            <button type="submit" class="nav-link" data-bss-hover-animate="pulse" name="logout" style="color: #3ad370;border-width: 2px;border-style: solid; background-color: white; border-color: #3ad370 ; margin-top: 0px"> <i class="fa fa-sign-out"></i>&nbsp;Logout</button>
                           <?php
